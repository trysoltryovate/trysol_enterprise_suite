...
//               >
//                 <svg
//                   className="fill-none stroke-teal-400 duration-300 group-hover:fill-white group-active:fill-teal-500 group-active:stroke-teal-200 group-active:duration-0"
//                   viewBox="0 0 24 24"
//                   height="30px"
//                   width="30px"
//                   xmlns="http://www.w3.org/2000/svg"
...
//                       } else {
//                         setSelectedCandidates(
//                           filteredCandidates.map((candidate) => candidate.sNo),
//                         );
//                       }
//                     }}
//                     checked={
...
//                 <tr key={candidate.id} className="border transition-colors duration-200 hover:bg-blue-100">
//                   <td className="px-4 py-2">
//                     <input
//                       type="checkbox"
//                       checked={selectedCandidates.includes(candidate.sNo)}
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 sm:p-6">
      <div className="rounded-lg bg-white p-4 sm:p-6 shadow-md">
        <p className="mb-4 flex items-center rounded-md bg-blue-100 p-3 text-sm sm:text-base text-gray-600">
          <FiInfo className="mr-2" />
          The candidates directory lists all candidates in the organization.
        </p>
        ...
        <div className="mb-4 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex flex-col gap-2 md:flex-row md:items-center md:gap-4">
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-800">Candidates List</h2>
            <div className="relative w-full md:w-80">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400">
                <FiSearch />
              </span>
...
<button
        ...
        <div className="w-full overflow-x-auto">
          <table className="min-w-[1000px] w-full rounded-lg border border-gray-300 bg-white shadow-md text-sm">
            <thead className="bg-blue-300">
              <tr>
                <th className="border px-4 py-2">
                  <input
                ...
                {[
                  "S.No", "Mode", "Name", "Skill", "Projects/Shadow", "Experience", "NDA",
                  "CV Ready", "LinkedIn", "Date Of NDA", "Notary", "Affidavit",
                  "Salary On Deployed", "Salary On Bench", "Ready To Travel",
                  "Email", "Mobile Num", "Edit", "Delete",
                ].map((heading, index) => (
                  <th key={index} className="border px-4 py-2 text-left">
                    {heading}
                  </th>
